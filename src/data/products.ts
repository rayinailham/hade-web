...
export const products: Product[] = [
  {
    ...
    images: IMG(
      ...
      [
        'clamp-adapter-dslr-2026-hero-canon.webp',
        'clamp-adapter-dslr-2026-landscape-canon.webp',
        'clamp-adapter-dslr-2026-with-lens-cap.webp',
        'clamp-adapter-dslr-2026-aperture-nikon-variant.webp',
        'clamp-adapter-dslr-2026-portrait-position.webp',
        'clamp-adapter-dslr-2026-canon-nikon-variants.webp',
        'clamp-adapter-dslr-2026-tripod-collar-detail.webp',
      ],
    ),
  },
  {
    ...
    images: IMG(
      ...
      [
        'clamp-adapter-mirrorless-2026-hero.webp',
        'clamp-adapter-mirrorless-2026-with-lens.webp',
        'clamp-adapter-mirrorless-2026-canon-mount-side.webp',
        'clamp-adapter-mirrorless-2026-front-mount.webp',
      ],
    ),
  },
  {
    ...
    images: IMG(
      ...
      [
        'direc-sensor-dslr-ffd-hero-canon-kit.webp',
        'direc-sensor-dslr-ffd-canon-nikon-mounts.webp',
        'direc-sensor-dslr-ffd-canon-side.webp',
        'direc-sensor-dslr-ffd-spec-diagram.webp',
        'direc-sensor-dslr-ffd-adjustment-illustration.webp',
        'direc-sensor-dslr-ffd-nikon-back-detail.webp',
        'direc-sensor-dslr-ffd-with-tamron-tele.webp',
        'direc-sensor-dslr-ffd-collar-replacement.webp',
        'direc-sensor-dslr-ffd-focus-range-back.webp',
      ],
    ),
  },
  {
    ...
    images: IMG(
      ...
      [
        'direc-sensor-sony-emount-hero-with-grip.webp',
        'direc-sensor-sony-emount-side-with-cap.webp',
        'direc-sensor-sony-emount-front-mount-cap.webp',
        'direc-sensor-sony-emount-with-7artisans-lens.webp',
        'direc-sensor-sony-emount-mount-ring-detail.webp',
      ],
    ),
  },
  {
    ...
    images: IMG(
      'direc-sensor-mft',
      [
        'direc-sensor-mft-hero-mount-cap.webp',
        'direc-sensor-mft-with-lens-side.webp',
        'direc-sensor-mft-aluminium-variant.webp',
        'direc-sensor-mft-front-mount-detail.webp',
        'direc-sensor-mft-side-profile.webp',
      ],
    ),
  },
  {
    ...
    images: IMG(
      'bracket-rigging-system-2026',
      [
        'bracket-rigging-system-2026-overview.webp',
        'bracket-rigging-system-2026-phone-mounted-tripod.webp',
        'bracket-rigging-system-2026-phone-with-telephoto.webp',
        'bracket-rigging-system-2026-vh-position-detail.webp',
        'bracket-rigging-system-2026-mounted-tripod-side.webp',
        'bracket-rigging-system-2026-full-setup.webp',
        'bracket-rigging-system-2026-landscape-position.webp',
        'bracket-rigging-system-2026-l-bracket-detail.webp',
        'bracket-rigging-system-2026-l-bracket-side.webp',
      ],
    ),
  },
  {
    ...
    images: IMG(
      ...
      [
        'phone-grip-bluetooth-shooter-hero-side.webp',
        'phone-grip-bluetooth-shooter-with-phone-back.webp',
        'phone-grip-bluetooth-shooter-with-fill-light.webp',
        'phone-grip-bluetooth-shooter-portrait-mode.webp',
        'phone-grip-bluetooth-shooter-with-remote.webp',
      ],
    ),
  },
]
